...
// 	mtb_mtb_Start_This_Service(pngOnlineImageDrawer_Sv);
// 	return 0;
// }
...
void mtb_Draw_Online_Png(const PNG_OnlineImage_t* images, size_t drawPNGsCount, ImgWipeFn_ptr wipePreviousImgs){
...
// 	mtb_mtb_Start_This_Service(svgOnlineImageDrawer_Sv);
// 	return 0;
// }
...
void mtb_Draw_Online_Svg(const SVG_OnlineImage_t* images, size_t drawSVGsCount, ImgWipeFn_ptr wipePreviousImgs){
