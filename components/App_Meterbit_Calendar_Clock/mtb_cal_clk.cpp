...
EXT_RAM_BSS_ATTR Applications_StatusBar *classicClock_App = new Applications_StatusBar(classicClock_App_Task, &classicClock_Task_H, "Classic Clock", 10240, pdTRUE);
//***************************************************************************************************
void  classicClock_App_Task(void* dApplication){
  ...
  ble_AppCom_Parser_Sv->register_BLE_Com_ServiceFns(clock_Color_Change, get_NTP_Local_Time);
