...
EXT_RAM_BSS_ATTR Mtb_Applications_FullScreen *audSpecAnalyzer_App = new Mtb_Applications_FullScreen(audSpecAnalyzer_App_Task, &audSpecAnalyzer_Task_H, "Audio Spectr", 6144);
