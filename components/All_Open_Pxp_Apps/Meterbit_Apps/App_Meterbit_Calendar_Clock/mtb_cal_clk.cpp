...
EXT_RAM_BSS_ATTR Mtb_Applications_StatusBar *classicClock_App = new Mtb_Applications_StatusBar(classicClock_App_Task, &classicClock_Task_H, "Classic Clock", 10240, pdTRUE);
//***************************************************************************************************
