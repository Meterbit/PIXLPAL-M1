...
EXT_RAM_BSS_ATTR Mtb_Applications_StatusBar *calendarClock_App = new Mtb_Applications_StatusBar(calendarClock_App_Task, &classicClock_Task_H, "Classic Clock", {0,0}, 2560);
//***************************************************************************************************
void  calendarClock_App_Task(void* dApplication){
