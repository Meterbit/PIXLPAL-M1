...
EXT_RAM_BSS_ATTR Mtb_Applications_FullScreen *usbOTA_Update_App = new Mtb_Applications_FullScreen(usbFirmwareUpdateTask, &usbFirmwareUpdate_H, "OTA FW UPDATE", {12,0}, 3072);
